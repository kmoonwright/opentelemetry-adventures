...
log_stream.setFormatter(json_formatter)
logger.addHandler(log_stream)

# OTEL LogHandler - Currently experimental, subject to change
from opentelemetry.sdk._logs import LoggingHandler
otel_log = LoggingHandler(sys.stdout)
otel_log.setFormatter(json_formatter)
logger.addHandler(otel_log)
